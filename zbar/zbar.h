 ...
 * @since 0.11
 */
extern zbar_orientation_t zbar_symbol_get_orientation(
 ...
 * @since 0.10
 */
extern const zbar_symbol_set_t *zbar_symbol_get_components(
    const zbar_symbol_t *symbol);
 ...
 * @since 0.10
 */
extern const zbar_symbol_t *zbar_symbol_first_component(
    const zbar_symbol_t *symbol);
 ...
 * @since 0.10
 */
extern const zbar_symbol_t *zbar_symbol_set_first_symbol(
 ...
 * @since 0.11
 */
extern const zbar_symbol_t *zbar_symbol_set_first_unfiltered(
    const zbar_symbol_set_t *symbols);
 ...
 * @since 0.10
 */
extern const zbar_symbol_set_t *zbar_image_get_symbols(
 ...
 */
extern zbar_image_data_handler_t *zbar_processor_set_data_handler(
    zbar_processor_t *processor, zbar_image_data_handler_t *handler,
    const void *userdata);
 ...
 * @since 0.10
 */
extern const zbar_symbol_set_t *zbar_processor_get_results(
 ...
 */
static __inline int zbar_processor_error_spew(const zbar_processor_t *processor,
                                              int verbosity) {
  return (_zbar_error_spew(processor, verbosity));
}

/** retrieve the detail string for the last processor error. */
static __inline const char *zbar_processor_error_string(
    const zbar_processor_t *processor, int verbosity) {
  return (_zbar_error_string(processor, verbosity));
}

/** retrieve the type code for the last processor error. */
static __inline zbar_error_t zbar_processor_get_error_code(
    const zbar_processor_t *processor) {
...
static __inline zbar_error_t zbar_video_get_error_code(
...
static __inline const char *zbar_window_error_string(
    const zbar_window_t *window, int verbosity) {
  return (_zbar_error_string(window, verbosity));
}

/** retrieve the type code for the last window error. */
static __inline zbar_error_t zbar_window_get_error_code(
 ...
 * @returns the previously registered handler
 */
extern zbar_image_data_handler_t *zbar_image_scanner_set_data_handler(
    zbar_image_scanner_t *scanner, zbar_image_data_handler_t *handler,
    const void *userdata);
 ...
 * @since 0.4
 */
static __inline int zbar_image_scanner_parse_config(
    zbar_image_scanner_t *scanner, const char *config_string) {
  zbar_symbol_type_t sym;
  zbar_config_t cfg;
  int val;
  return (zbar_parse_config(config_string, &sym, &cfg, &val) ||
 ...
 * @since 0.10
 */
extern const zbar_symbol_set_t *zbar_image_scanner_get_results(
 ...
 * @returns the previously registered handler
 */
extern zbar_decoder_handler_t *zbar_decoder_set_handler(
    zbar_decoder_t *decoder, zbar_decoder_handler_t *handler);
